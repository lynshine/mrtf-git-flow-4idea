...
public class InitPluginDialog extends DialogWrapper {
    ...
    private void enableFields() {
        ...
        versionPrefixTextField.setEnabled(true);
        releaseFinishIsDeleteReleaseCheckBox.setEnabled(true);
        releaseFinishIsDeleteFeatureCheckBox.setEnabled(true);
    }
    ...
    private void initDialog(Project project) {
        ...
        if (options.isPresent()) {
            ...
            versionPrefixTextField.setText(options.get().getVersionPrefix());
            releaseFinishIsDeleteReleaseCheckBox.setSelected(options.get().isReleaseFinishIsDeleteRelease());
            releaseFinishIsDeleteFeatureCheckBox.setSelected(options.get().isReleaseFinishIsDeleteFeature());
        } else {
